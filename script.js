...
// Quiz data embedded directly in JavaScript to avoid CORS issues
const quizData = [
	{
...
function buildQuiz() {
    console.log('Building quiz with English questions');
    ...
    quizData.forEach((questionData, index) => {
        ...
        explanation.innerHTML = `<b>Explanation:</b> ${questionData.explanation}`;
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM loaded, building quiz...');
    buildQuiz();
});